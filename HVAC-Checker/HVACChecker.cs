...
namespace HVAC_CheckEngine
{
     ...
     */
        ...
        //获得所有的汽车库和修车库的集合
        //获得所有敞开式汽车库的集合
        //获得建筑面积小于1000m2的地下汽车库和修车库
        //从汽车库、修车库集合中除去敞开式汽车库和面积小于1000㎡的地下汽车库和修车库
        //依次遍历剩余的汽车库、修车库中集合中的房间
        //如果当前房间没有设置排烟系统
        //则将审查结果标记为不通过，且把当前房间记录进审查结果中。并在批注中记录此房间未设排烟系统
        //如果当前房间没有防烟分区
        //则将审查结果标记为不通过，且把当前房间记录进审查结果中。并在批注中记录此房间未设置防烟分区。
        //如果审查通过
        //则在审查结果批注中注明审查通过相关内容
        //如果审查不通过
        //则在审查结果中注明审查不通过的相关内容
        ...
        public static BimReview GB50067_2014_8_2_1()
        {
            ...
            //获得所有的汽车库和修车库的集合
            List<Room> garage = HVACFunction.GetRooms("汽车库");
            garage.AddRange(HVACFunction.GetRooms("修车库"));
            //获得所有敞开式汽车库的集合
            List<Room> openGarage = HVACFunction.GetRooms("敞开式汽车库");
            //获得建筑面积小于1000m2的地下汽车库和修车库
            List<Room> underGroundSmallerThan1000sqmGarage=
            return result;
        }
