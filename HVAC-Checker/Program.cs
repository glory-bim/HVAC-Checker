...
namespace HVAC_CheckEngine
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string strArchPath = HVACFunction.GetCurrentPath("/建筑.GDB");
            //string strHVACPath = HVACFunction.GetCurrentPath("/机电.GDB");
          ...
          HVACFunction.isAllBranchLinkingAirTerminal(fan);
            Console.ReadLine();
        }
    }
